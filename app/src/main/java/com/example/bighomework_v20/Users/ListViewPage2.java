...
public class ListViewPage2 extends AppCompatActivity {
    ...
    private void storeData() {
        ...
        pagelist.add(new com.example.bighomework_v20.Users.Page1());
        pagelist.add(new com.example.bighomework_v20.Users.Page2());
        pagelist.add(new com.example.bighomework_v20.Users.Page3());
    }
    //适配器类
